...
public class LoginControllerTests {
    ...
    public void login_ValidCredentials_ShouldReturnToken() {
        ...
        when(mockUser.token(secret)).thenReturn(token);
    ...
    public void login_NullRequest_ShouldThrowException() {
        ...
        try {
            ...
            assertTrue("Exception should be of type ResponseStatusException", ex instanceof ResponseStatusException);
            assertEquals("Exception status should be BAD_REQUEST", HttpStatus.BAD_REQUEST, ((ResponseStatusException) ex).getStatus());
        }
    }
}
